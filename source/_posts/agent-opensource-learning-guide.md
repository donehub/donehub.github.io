...
1. 今天：克隆 LangGraph 仓库，看 `react-agent.ipynb`
2. 本周：用 LangGraph 写一个能调用搜索工具的 Agent
3. 下周：看 GPT-Researcher 源码，理解完整流程
4. 两周后：用 LangChain4j 重写你的 Agent Demo

**记住**：概念是索引，项目是内容。边看边写，效率最高。
